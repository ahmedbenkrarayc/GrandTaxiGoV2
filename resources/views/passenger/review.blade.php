    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-white/10 backdrop-blur-md rounded-xl p-6 shadow-lg mb-8">
        <div class="flex items-center space-x-6">
          <img src="{{ $reservation->driver->user->photo }}" alt="Driver" class="w-16 h-16 rounded-full">
          <div>
      ...
      <form method="POST" action="/passenger/rate" class="bg-white/10 backdrop-blur-md rounded-xl p-8 shadow-lg">
        @csrf
